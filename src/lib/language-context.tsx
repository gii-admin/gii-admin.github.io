...
const translations = {
  en: {
    ...
    'achievements.emergencySOS': 'AI-powered threat detection and real-time risk assessment',
    'achievements.gpsSharing': 'Machine learning algorithms for pattern recognition and anomaly detection',
    'achievements.safeZoneNotifications': 'Intelligent emergency response with automated alert system',
    'achievements.nextInnovation': 'EcoTrace',
    'achievements.ecoTraceDesc': 'An AI-powered sustainability platform that helps individuals and organizations track, reduce, and offset their carbon footprint through intelligent analysis.',
    'achievements.upcomingProjects': 'EcoTrace is an AI-powered sustainability platform that helps individuals and organizations track, reduce, and offset their carbon footprint. By leveraging machine learning algorithms and real-time data analysis, EcoTrace provides personalized recommendations for sustainable living and enables communities to work together toward carbon neutrality.',
    'achievements.comingSoon': 'Sustainability & Carbon Tracking Platform',
    'achievements.ecoTraceCrossPlatform': 'AI-powered carbon footprint calculator',
    'achievements.ecoTracePersonalized': 'Personalized sustainability recommendations',
    'achievements.ecoTraceCommunity': 'Community carbon reduction challenges',
    'achievements.ecoTraceKeyFeatures': 'Key Features',
    'achievements.ecoTraceAICalculator': 'AI-driven carbon footprint analysis for daily activities',
    'achievements.ecoTraceRealTime': 'Real-time environmental impact tracking',
    'achievements.ecoTraceGameified': 'Gamified challenges and rewards system',
  ...
  ko: {
    ...
    'achievements.emergencySOS': 'AI 기반 위협 감지 및 실시간 위험 평가',
    'achievements.gpsSharing': '패턴 인식 및 이상 탐지를 위한 머신러닝 알고리즘',
    'achievements.safeZoneNotifications': '자동화된 경보 시스템을 갖춘 지능형 응급 대응',
    'achievements.nextInnovation': 'EcoTrace',
    'achievements.ecoTraceDesc': '지능형 분석을 통해 개인과 조직이 탄소 발자국을 추적, 감소, 상쇄할 수 있도록 돕는 AI 기반 지속가능성 플랫폼입니다.',
    'achievements.upcomingProjects': 'EcoTrace는 개인과 조직이 탄소 발자국을 추적, 감소, 상쇄할 수 있도록 돕는 AI 기반 지속가능성 플랫폼입니다. 머신 러닝 알고리즘과 실시간 데이터 분석을 활용하여 지속 가능한 삶을 위한 개인화된 권장 사항을 제공하고 커뮤니티가 탄소 중립을 향해 함께 노력할 수 있도록 지원합니다.',
    'achievements.comingSoon': '지속가능성 및 탄소 추적 플랫폼',
    'achievements.ecoTraceCrossPlatform': 'AI 기반 탄소 발자국 계산기',
    'achievements.ecoTracePersonalized': '개인화된 지속가능성 권장 사항',
    'achievements.ecoTraceCommunity': '커뮤니티 탄소 감소 챌린지',
    'achievements.ecoTraceKeyFeatures': '주요 기능',
    'achievements.ecoTraceAICalculator': '일상 활동에 대한 AI 기반 탄소 발자국 분석',
    'achievements.ecoTraceRealTime': '실시간 환경 영향 추적',
    'achievements.ecoTraceGameified': '게임화된 챌린지 및 보상 시스템',
